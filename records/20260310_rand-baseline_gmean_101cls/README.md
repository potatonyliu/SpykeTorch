This linear layer baseline applies mean(dim(-2, -1)) to reduce all spatial information in all output features. It was built with the same model parameters as the actual SNN model in run_experiment. I passed it through random weight but maintained all other parameters, so it reflects the accuracy baseline before training.

The linear layer can classify 101 classes with 0.19 accuracy over 10k iterations. 
               ...
               1       0.15      0.39      0.21        87
               2       0.00      0.00      0.00        40
               3       0.17      0.85      0.28       160
               4       0.00      0.00      0.00        11
               5       0.25      0.94      0.40       160
               6       0.00      0.00      0.00         8
               7       0.00      0.00      0.00         8
               8       0.00      0.00      0.00         9
               9       0.00      0.00      0.00        11
        ...
        accuracy                           0.19      1742
       macro avg       0.01      0.02      0.01      1742
    weighted avg       0.05      0.19      0.08      1742